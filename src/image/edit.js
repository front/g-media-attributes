...
import { url, i18n, element, blob, components, data, editor, viewport } from 'wp';
...
const { getBlobByURL, revokeBlobURL, isBlobURL } = blob;
const {
  Button,
  ButtonGroup,
  IconButton,
...
const { withViewportMatch } = viewport;
...
class ImageEdit extends Component {
  ...
  onImageError (url) {  // eslint-disable-line
    // FIXME: Check if there's an embed block that handles this URL.
  }
